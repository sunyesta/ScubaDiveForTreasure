...
-- Composites
BehaviorTree.Sequence = function(params)
	return { type = "sequence", params = params }
end
BehaviorTree.Selector = function(params)
	return { type = "selector", params = params }
end
BehaviorTree.Random = function(params)
	return { type = "random", params = params }
end
BehaviorTree.While = function(params)
	return { type = "while", params = params }
end

-- Decorators
BehaviorTree.Succeed = function(params)
	return { type = "always_succeed", params = params }
end
BehaviorTree.Fail = function(params)
	return { type = "always_fail", params = params }
end
BehaviorTree.Invert = function(params)
	return { type = "invert", params = params }
end
BehaviorTree.Repeat = function(params)
	return { type = "repeat", params = params }
end

-- Leafs
BehaviorTree.Task = function(params)
	return { type = "task", params = params }
end
BehaviorTree["External Task"] = function(params)
	return { type = "task", params = params }
end
BehaviorTree.Tree = function(params)
	return { type = "tree", params = params }
end
BehaviorTree["Blackboard Query"] = function(params)
	return { type = "blackboard", params = params }
end
